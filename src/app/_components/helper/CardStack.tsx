...
export const CardStack = ({
  ...
  return (
    <div className={`relative w-full h-90 sm:h-120 md:h-185 lg:h-115 xl:h-110 ${className || ""}`}>
        ...
        return (
          ...
          >
            ...
            <div className="absolute top-2 left-4 z-10">
              ...
              <div className="absolute bottom-2 left-4 z-10" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-between flex-1 relative">
              ...
              <div className="flex items-center justify-between gap-4 pt-1 md:pt-0 lg:pt-0 xl:pt-0">
                <div className="flex items-center gap-4">
                  {card.githubUrl && (
                    <>
                      {Array.isArray(card.githubUrl) ? (
                        <>
                          {/* Frontend Button */}
                          <a
                            href={card.githubUrl[0]}
                            target="_blank"
