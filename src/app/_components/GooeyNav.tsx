    ...
    <>
      ...
      <style>
        {`
          ...
          /* REMOVE OR COMMENT OUT THIS BLOCK TO REMOVE THE BLACK RECTANGLE */
      ...
      <div className="relative flex justify-center mt-5" ref={containerRef}>
        <nav className="flex relative" style={{ transform: 'translate3d(0,0,0.01px)' }}>
          <ul
            ref={navRef}
            className={`flex ${isHorizontal ? "flex-row gap-8" : "flex-col gap-4"} list-none p-0 px-4 m-0 relative z-[3] items-center`}
            style={{
              color: 'white',
